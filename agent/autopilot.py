...
- Если пост про конкретный продукт — упомяни конкретный факт о ценах на него
- В конце поставь ОДНУ ссылку: {SITE_LINK}

Ссылку упоминай ТОЛЬКО один раз, в самом конце. Никаких повторов.
